...
# SECURITY NOTE: secret key is changed during deployment and is randomized in each build
SECRET_KEY = 'h$zyp=z$!o=2^_mh7c6r3+ep%sm=n7oipaeg^e47a%20zzzn!e'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dosgamesfinder.views.genre_dropdown'
            ],
        },
    },
]
